...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, FormsModule, MatInputModule, MatFormField, MatOptionModule, MatSelectModule],
...
export class CreateReportComponent {
  ...
  report_types: { key: string; value: string }[] = [ 
    ...
    { key: 'JOB_OPPORTUNITY', value: 'Job, investment, money making opportunity, franchise' },
    { key: 'SERVICE_SCAM', value: 'Phone, internet, TV Service' },
    { key: 'HEALTH_SCAM', value: 'Health (ex. weightloss, eye care, treatment' },
