...
@Module({
  imports: [
    ...
    ContextTypeModule, 
    MethodModule],
  controllers: [AppController, AnnotationController, ContextController, ContextTypeController, MethodController, ReportsController, TypeController, UsersController],
  providers: [AppService, AnnotationService, ContextService, ContextTypeService, MethodService, ReportsService, TypeService, UsersService],
